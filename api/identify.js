...
const PROMPT = [
  ...
  'Dense insect choruses — crickets, katydids, cicadas — are the dominant night sound in this',
  'habitat and can be mistaken for rainfall or static; if the sound is a continuous high-frequency',
  'wall, consider stridulating insects before weather.',
  'Only use "confident" when the sound has a distinct, identifiable structure — a continuous',
  'undifferentiated texture should be "likely" or "possible" at most.',
  'Moving water and rainfall both produce continuous broadband noise and are easily confused:',
  'a river or stream is steady, unchanging in intensity over many seconds, and has a',
  'lower-frequency rumble beneath the hiss, while rain fluctuates in intensity, contains audible',
  'individual droplet impacts on leaves, and often accompanies wind or distant thunder.',
  'Dense insect chorus is a third possibility, with a distinctly higher-frequency, pulsing or',
  'shimmering texture. Distinguish carefully between running water, rainfall and stridulating',
  'insects before reporting any of them, and prefer "likely" over "confident" when the sound is',
